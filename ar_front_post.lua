...
if DMCWO == nil then
	...
	--[[tweak_data.weapon.factory.wpn_fps_ass_scar.adds = {
			wpn_fps_upg_o_specter = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_aimpoint = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_aimpoint_2 = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_docter = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_eotech = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_t1micro = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_cmore = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_acog = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_eotech_xps = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_rx01 = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_rx30 = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_cs = {"wpn_fps_ass_scar_o_flipups_up"},
			wpn_fps_upg_o_reflex = {"wpn_fps_ass_scar_o_flipups_up"},
		}--
		
	tweak_data.weapon.factory.wpn_fps_ass_l85a2.adds = {
			wpn_fps_upg_o_specter = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_aimpoint = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_aimpoint_2 = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_docter = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_eotech = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_t1micro = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_cmore = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_acog = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_eotech_xps = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_rx01 = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_rx30 = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_cs = {"wpn_fps_ass_l85a2_o_standard"},
			wpn_fps_upg_o_reflex = {"wpn_fps_ass_l85a2_o_standard"},
		}--]]
		
	tweak_data.weapon.factory.parts.wpn_fps_upg_o_specter.forbids = {"wpn_fps_amcar_uupg_body_upperreciever",  "wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_m16_o_handle_sight", "wpn_fps_ass_l85a2_o_standard" }
